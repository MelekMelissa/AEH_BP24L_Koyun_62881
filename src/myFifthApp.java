...
public class myFifthApp {
    public static void main(String[] args) {
        // Calling the method with parameters: character '*', width 6, and height 4
        printCharacterBlock('*', 6, 4);  // Output: 6 characters per line, 4 lines total
    }

    /**
     * This method prints a block of characters to the console.
     *
     * @param symbol The character to print
     * @param width  Number of characters per line
     * @param height Number of lines
     */
    public static void printCharacterBlock(char symbol, int width, int height) {
        for (int i = 0; i < height; i++) { // Loop for number of lines
            for (int j = 0; j < width; j++) { // Loop for number of characters per line
